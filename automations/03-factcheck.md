...
Adult name, every charge the book-in report prints, booking date, agency, source. The body is one or two short sentences. Ordinary English only ("accused of …"). Hold a draft that still uses "In plain words," that labels felony/misdemeanor degrees, that cites Minn. Stat., that says "The report cites," or that adds "It is not a conviction" as a refrain. The plain sentence is not a new claim that the person did the act. If it adds a drug, a weapon, an injury, a relationship, or any other fact the book-in report did not print, cut that element or hold the story. If a draft includes a street address, an age, a date of birth, an officer, an arrest location, a "How to follow it" section, or the word guilty, that is a hold until those words are gone. If you can remove them without losing a charge, fix and then re-check the charges against the PDF before you pass.
