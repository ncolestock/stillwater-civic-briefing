...
3. Open that official page. Write only what it says: name, office, how they came to it if the page says, and what the office does. If the page does not say it, leave it out. Do not read phone numbers, email addresses, fax numbers, or a staff directory. The source URL in `summary` is how a listener checks the office.
