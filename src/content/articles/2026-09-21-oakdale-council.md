...
The claims line recommends approval of claims from Sept. 9 through Sept. 22 in the amount of $2,884,832.62.

Resolution 2026-70 would authorize the sale of general-obligation improvement, sales-tax, and capital-improvement bonds, Series 2026A, subject to parameters set in the resolution, and would establish a pricing committee. The agenda outline does not state a par amount.

Two donations are listed, each needing a two-thirds vote. One is fitness equipment from Planet Fitness, valued at approximately $157,438. The other is two bicycle repair stations and mounting posts from Park Tool, valued at approximately $1,600. A recreation item accepts $2,400 in sponsorships for a Family Fun Flatables event.

The open forum allows up to three minutes per speaker. The agenda says the council will not act on items raised only in that period.
